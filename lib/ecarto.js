...
function carbonData(){
     ...
     d3.select("#map-container > svg").append("text").attr("x",0).attr("y",560).attr("dy",".35em").text("CO2 Emission (Billion Metric Tonnes)");
...
function energyData(){
    ...
    //stratbutton.onclick = false;

     d3.selectAll("svg > *").data([]).exit().remove();
     //d3.selectAll("svg > *").exit().remove();
     //d3.select("#map").data().exit().remove();
...
function gdpData(){
     ...
     d3.selectAll("svg > *").data([]).exit().remove();
     d3.selectAll("#axis-container > *").remove();
     d3.select("#map-container > svg").append("text").attr("x",0).attr("y",560).attr("dy",".35em").text("GDP PPP (Trillion 2005 US Dollar)");
...
function populationData(){
     d3.selectAll("svg > *").data([]).exit().remove();
     d3.selectAll("#axis-container > *").remove();
     d3.select("#map-container > svg").append("text").attr("x",0).attr("y",560).attr("dy",".35em").text("Population (Millions)");
    ...
    2026,2027,2028,2029,2030,2031,2032,2033,2034,2035,2036,2037,2038,2039,2040],
       fields = [
           {name: "Population (Millions)", id: "Population", key: "Population%d", years: years}
     ],

      field = fields[0],
      year = years[0],
      mycolor = ['#ffabab','#f86161','#9b0707'],
      colors = mycolor.map(function(rgb) { return d3.hsl(rgb); });
